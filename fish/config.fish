...
alias al="~/github/atlaspack/packages/dev/atlaspack-link/bin.js"
alias au="~/github/atlaspack/packages/dev/atlaspack-link/bin.js unlink"
alias aq="~/github/atlaspack/packages/dev/query/src/bin.js"
